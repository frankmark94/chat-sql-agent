...
class SendEmailInput(BaseModel):
    ...
    subject: Optional[str] = Field(default="SQL Analysis Report", description="Email subject")
    body: Optional[str] = Field(default="Please find the attached SQL analysis report.", description="Email body")
...
class SendEmailTool(BaseTool):
    ...
    def _run(self, report_path: str, to: str, subject: str = "SQL Analysis Report", body: str = "Please find the attached SQL analysis report.") -> str:
        try:
...
class QueryVisualizationInput(BaseModel):
    ...
    title: Optional[str] = Field(default="Query Result Visualization", description="Chart title")
...
class QueryVisualizationTool(BaseTool):
    ...
    def _run(self, query_result: str, chart_type: str, title: str = "Query Result Visualization") -> str:
        try:
...
def get_custom_tools(enable_reporting: bool = True, enable_email: bool = True) -> List[BaseTool]:
    """
