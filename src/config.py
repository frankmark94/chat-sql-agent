...
class Settings(BaseSettings):
    ...
    DEFAULT_DB_URL: Optional[str] = Field(default=None, description="Default database connection URL")
    ...
    STREAMLIT_SERVER_ADDRESS: str = Field(default="localhost", description="Streamlit server address")
    
    # Security Configuration
    SECRET_KEY: Optional[str] = Field(default=None, description="Secret key for session management")
    ALLOWED_HOSTS: Optional[List[str]] = Field(default_factory=lambda: ["localhost", "127.0.0.1"], description="Allowed host names")
