...
def create_sample_database(db_path="sample_ecommerce.db"):
    ...
    cursor.executemany('INSERT INTO categories VALUES (?, ?, ?, DATE("now"))', categories_data)
    ...
    for i in range(1, 501):
        ...
        customers_data.append((
            i, first_name, last_name, email, fake.phone_number(),
            fake.date_of_birth(minimum_age=18, maximum_age=80),
            random.choice(['M', 'F', 'Other']),
            fake.country(), fake.state(), fake.city(), fake.postcode(),
    ...
    for i in range(1, 201):
        ...
        products_data.append((
            i, fake.catch_phrase(), category_id, brand, price, cost, stock,
            round(random.uniform(0.1, 50), 2),  # weight
            f"{random.randint(10, 50)}x{random.randint(10, 50)}x{random.randint(5, 30)}cm",
            random.choice(colors), random.choice(sizes),
            fake.text(max_nb_chars=200), rating, review_count,
    ...
    for i in range(1, 1001):
        ...
        discount = round(random.uniform(0, subtotal * 0.2), 2) if random.random() < 0.3 else 0
        total = subtotal + tax_amount + shipping_cost - discount
        
        orders_data.append((
            i, customer_id, order_date, status, random.choice(payment_methods),
            fake.address(), fake.address(), subtotal, tax_amount, shipping_cost,
            discount, total, shipped_date, delivered_date, tracking_number,
    ...
    for i in range(1, 2001):
        ...
        order_items_data.append((
            i, order_id, product_id, quantity, unit_price, discount_percent, line_total
        ))
    ...
    for i in range(1, 801):
        ...
        review_titles = [
            "Great product!", "Love it!", "Excellent quality", "Good value",
            "Not what I expected", "Amazing!", "Perfect", "Disappointed",
            "Highly recommend", "Outstanding", "Poor quality", "Fantastic"
        ]
        
        reviews_data.append((
            i, product_id, customer_id, order_id, rating,
    ...
    summary_queries = [
        ...
        ("Total Revenue", "SELECT ROUND(SUM(total_amount), 2) FROM orders WHERE order_status = 'Delivered'"),
